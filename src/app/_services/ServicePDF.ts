		...
		const pdfDefinition: any = {
		  ...
		  content: [
			...
			},
			{
				...
				body: [
				  [{text: 'TOMADOR:', bold: true, border: [false, false, false, false]}, {text: this.xtomador, border: [false, false, false, false]}, {text: 'C.I. / R.I.F.:', bold: true, border: [false, false, false, false]}, {text: this.xrif, border: [false, false, false, false]}, {text: 'RAMO PÓLIZA:', bold: true, border: [false, false, false, false]}, {text: 'AUTOMÓVIL', border: [false, false, false, false]}]
				]
				}
			},
			{
